...
setup(name='bcdi', version='0.1.0',
      ...
      scripts=['bcdi/algorithms/scripts/flatten_intensity.py',
               ...
               'bcdi/postprocessing/scripts/angular_profile.py',
               'bcdi/postprocessing/scripts/line_profile.py',
               ...
               'bcdi/utils/scripts/bcdi_apodize.py',
               'bcdi/utils/scripts/angular_avg_3Dto1D.py',
               'bcdi/utils/scripts/calibration_grid_SEM.py',
               ...
               'bcdi/utils/scripts/bcdi_primes.py',
