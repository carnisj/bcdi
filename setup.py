...
setup(name='bcdi', version='0.0.8',
      ...
      scripts=['bcdi/facet_recognition/scripts/facet_strain.py',
               ...
               'bcdi/postprocessing/scripts/fit_1Dcurve.py',
               ...
               'bcdi/preprocessing/scripts/fit_background.py',
               'bcdi/preprocessing/scripts/preprocess_cdi_sequential.py',
               'bcdi/preprocessing/scripts/preprocess_cdi_combined.py',
               'bcdi/preprocessing/scripts/preprocess_bcdi_sequential.py',
               'bcdi/preprocessing/scripts/preprocess_bcdi_combined.py',
