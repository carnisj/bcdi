...
fig_size = (
    1200,
    1050,
)  # mayavi figure size in pixels (hor, ver), leave None for the default
azimuth = [
    90,
    -90,
    180,
    ...
    0,
    150,
]  # azimuthal angle or list of azimuthal angles for the Mayavi scene views
elevation = [
    90,
    90,
    90,
    ...
    90,
    70,
]  # zenith angle or list of zenith angles for the Mayavi scene views
roll = [
    90,
    -90,
    0,
    ...
    0,
    0,
]  # roll angle or list of roll angles for the Mayavi scene views
comment = [
    sample_name + "_{:5d}".format(scan) + "_top",
    sample_name + "_{:5d}".format(scan) + "_bottom",
    sample_name + "_{:5d}".format(scan) + "_side",
    sample_name + "_{:5d}".format(scan) + "_revside",
    sample_name + "_{:5d}".format(scan) + "_front",
...
valid.valid_container(
    (flag_support, flag_amp, flag_phase, flag_strain, simulated_data),
...
file_path = filedialog.askopenfilename(
    initialdir=homedir, title="Select reconstruction file", filetypes=[("NPZ", "*.npz")]
)
...
if flag_support:
    ...
    fig, _, _ = gu.mlab_contour3d(
        x=grid_z,
        y=grid_y,
        z=grid_x,
        contours=[strain_isosurface],
        scalars=support[
