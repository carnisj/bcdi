...
class TestValidContainer(unittest.TestCase):
    ...
    def test_validcontainer_container_types_none(self):
        self.assertRaises(ValueError, valid.valid_container, obj=[], container_types=None)
    ...
    def test_validcontainer_container_wrong_type(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types={dict, tuple})

    def test_validcontainer_container_wrong_type_real(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types=Real)

    def test_validcontainer_container_length_float(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types=list, length=2.3)

    def test_validcontainer_container_length_negative(self):
        self.assertRaises(ValueError, valid.valid_container, obj=[], container_types=list, length=-2)
    ...
    def test_validcontainer_container_minlength_float(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types=list, min_length=2.3)

    def test_validcontainer_container_maxlength_float(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types=list, max_length=2.3)

    def test_validcontainer_container_minlength_negative(self):
        self.assertRaises(ValueError, valid.valid_container, obj=[], container_types=list, min_length=-2)

    def test_validcontainer_container_maxlength_negative(self):
        self.assertRaises(ValueError, valid.valid_container, obj=[], container_types=list, max_length=-2)
    ...
    def test_validcontainer_container_maxlength_equal_minlength_zero(self):
        self.assertTrue(valid.valid_container(obj=[], container_types=list, min_length=0, max_length=0))

    def test_validcontainer_container_itemtype(self):
        self.assertTrue(valid.valid_container(obj=[], container_types=list, item_types=int))
    ...
    def test_validcontainer_container_itemtype_none(self):
        self.assertTrue(valid.valid_container(obj=[], container_types=list, item_types=None))

    def test_validcontainer_container_itemtype_int(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types=list, item_types=2)
    ...
    def test_validcontainer_container_itemtype_collection(self):
        self.assertTrue(valid.valid_container(obj=[], container_types=list, item_types=(int, float)))

    def test_validcontainer_container_min_included(self):
        self.assertTrue(valid.valid_container(obj=[], container_types=list, min_included=0))

    def test_validcontainer_container_min_included_complex(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types=list, min_included=1+1j)

    def test_validcontainer_container_min_excluded(self):
        self.assertTrue(valid.valid_container(obj=[], container_types=list, min_excluded=0))

    def test_validcontainer_container_min_excluded_complex(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types=list, min_excluded=1+1j)

    def test_validcontainer_container_max_included(self):
        self.assertTrue(valid.valid_container(obj=[], container_types=list, max_included=0))

    def test_validcontainer_container_max_included_complex(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types=list, max_included=1+1j)

    def test_validcontainer_container_max_excluded(self):
        self.assertTrue(valid.valid_container(obj=[], container_types=list, max_excluded=0))

    def test_validcontainer_container_max_excluded_complex(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types=list, max_excluded=1+1j)

    def test_validcontainer_container_allownone(self):
        self.assertTrue(valid.valid_container(obj=[], container_types=list, allow_none=True))

    def test_validcontainer_container_allownone_int(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types=list, allow_none=0)

    def test_validcontainer_container_allownone_none(self):
        self.assertRaises(TypeError, valid.valid_container, obj=[], container_types=list, allow_none=None)
...
class TestValidKwargs(unittest.TestCase):
    ...
    def test_validkwargs_allowed_kwargs_dict(self):
        self.assertRaises(TypeError, valid.valid_kwargs, kwargs={}, allowed_kwargs={'test': 1})

    def test_validkwargs_allowed_kwargs_length(self):
        self.assertRaises(ValueError, valid.valid_kwargs, kwargs={}, allowed_kwargs='')

    def test_validkwargs_allowed_kwargs_items_length(self):
        self.assertRaises(ValueError, valid.valid_kwargs, kwargs={}, allowed_kwargs=('', 'test', 'moon'))

    def test_validkwargs_allowed_kwargs_items_type(self):
        self.assertRaises(TypeError, valid.valid_kwargs, kwargs={}, allowed_kwargs=(1, 'test', 'moon'))

    def test_validkwargs_allowed_kwargs_items_none(self):
        self.assertRaises(TypeError, valid.valid_kwargs, kwargs={}, allowed_kwargs=('test', None))
