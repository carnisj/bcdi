...
helptext = """
Calculate delta and gamma angles from the direct beam and Bragg peak positions, based on PETRAIII P10 geometry.
...
##############################
if rocking_angle == 'outofplane':  # om rocking curve
    tilt, _, _, _, inplane, outofplane = pru.motor_positions_p10(logfile, rocking_angle)
