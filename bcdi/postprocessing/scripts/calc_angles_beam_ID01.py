...
x_direct_0 = directbeam_x - direct_inplane*np.pi/180*sdd/detector.pixelsize  # nu is clockwise
...
bragg_inplane = inplane - detector.pixelsize*(bragg_x-x_direct_0)/sdd*180/np.pi  # nu is clockwise
