...
specfile_name = root_folder + 'alias_dict.txt'  # full path of the alias dictionnary 'alias_dict.txt'
#############################################################
...
##############################
tilt, inplane, outofplane = pru.motor_positions_sixs(logfile, frames_logical)
nb_frames = len(tilt)
if nz != nb_frames:
